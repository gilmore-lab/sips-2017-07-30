...
- **Do**:
    ...
    - Consult data repository expertise (e.g., [ICPSR](https://www.icpsr.umich.edu/icpsrweb/), [Dataverse](http://dataverse.org), [Databrary](http://databrary.org))
...
- **Share as openly as practicable**
    - With approved, authorized, [trusted](http://www.oclc.org/research/activities/trustedrep.html) data repositories
