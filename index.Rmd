...
- What risks do data pose?
- How should data be protected?
- What information is given to participant and what are they asked to consent to?
...
- How likely is it that reidentification could be acieved, and by whom?
...
- Avoid:
    - Making promises you cannot keep, e.g. "noone except the researchers in the project will ever see the data"
